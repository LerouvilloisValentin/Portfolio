        ...
        <div className="history">
                <div className="background_image">
                    <h1 className="title-content">Histoire</h1>
                        ...
                        En fait, ce que j'ai surtout réalisé c'est que le code m'intéressait davantage.
                        ...
                        Après avoir montré ma détermination par le biais de stage, de questionnaire et d'entretien avec des professionnels du domaine, je l'ai obtenu et j'ai commencé la formation chez O'clock. 
