            ...
            <Home/>
                <div className="background_image">
                    <h1 className="title-content">Projets</h1>
                        ...
                        <article className="projet">
                            <div className="wrapper-projet">
                                <a href="https://valoutube.surge.sh" target="_blank" rel="noreferrer" className="photo-valoutube">
                                <img className="photo-valoutube" src="img/valoutube.png" alt="photo_valoutube"></img> </a>            
