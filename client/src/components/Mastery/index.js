                        ...
                        <div class="column">
                            <div className="title_bio">Formation</div>
                                <p>
                                    ...
                                    nous avons aussi développé en <strong>SQL</strong> avec <strong>PostgreSQL</strong>.  Tous les jours un Challenge nous était donné,
                                    ...
                                    (réalisée en direct sur YouTube). Nous avons au cours de ce projet, collaboré comme si nous étions en entreprise avec les méthodes <strong>AGILE</strong> avec l'utilisation d'un <strong>cahier des charges</strong>,
                                     ...
                                     nos avancées quotidiennes. En collaboration entre équipes back et front (2 de chaque) avec réunion sur notre avancée chaque matin,
                                    puis  en étroite communication avec mon collègue front-end, nous avons dispatché les fonctionnalités à travailler et cela avec une deadline à respecter. Nous avions choisi de développer notre projet avec <strong>Redux</strong>.
